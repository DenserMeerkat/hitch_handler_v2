...
class CodeTheme extends ThemeExtension<CodeTheme> {
  ...
  static const CodeTheme light = CodeTheme(
    baseColor: Color(0xFFD9B9B9), // Pale Red
    numberColor: Color(0xFF7BBF85), // Pale Green
    commentColor: Color(0xFF7EA1CA), // Pale Blue
    keywordColor: Color(0xFFE7C4D8), // Light Desaturated Pink
    stringColor: Color(0xFFE3B67A), // Pale Orange
    punctuationColor: Color(0xFFB2B4C7), // Pale Gray
    classColor: Color(0xFF9CAFBF), // Pale Teal
    constantColor: Color(0xFF8CA4C7), // Pale Indigo
  );

  static const CodeTheme dark = CodeTheme(
    baseColor: Color(0xFF854747), // Deep Red
    numberColor: Color(0xFF3C8D56), // Deep Green
    commentColor: Color(0xFF3B6385), // Deep Blue
    keywordColor: Color(0xFFB386A9), // Light Desaturated Pink
    stringColor: Color(0xFFBC8930), // Deep Orange
    punctuationColor: Color(0xFF797B94), // Deep Gray
    classColor: Color(0xFF647682), // Deep Teal
    constantColor: Color(0xFF4D7D9E), // Deep Indigo
  );
